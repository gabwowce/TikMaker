...
const beats = [
  ...
  },
  {
    ...
    visualBrief:
      "First show a risky command being checked, then tests running after an edit.",
  ...
  },
  {
    role: "mechanism",
    purpose:
      "Explain that the developer chooses when the automatic command runs.",
    visualBrief:
      "Use the two-part composition to show the before and after moments.",
  ...
  },
  {
    ...
    visualBrief:
      "REPLACE RECORDING: open Claude Code settings, add a hook, and select the command it should run.",
  ...
  },
  {
    ...
    visualBrief:
      "REPLACE RECORDING: block a risky command, then show tests starting automatically after an edit.",
  ...
  },
  {
    role: "cta",
    purpose:
      "Invite viewers to follow for more understandable Claude Code lessons.",
