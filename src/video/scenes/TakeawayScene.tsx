...
import { Headline, BodyLargeText, Badge, renderHighlighted } from "../typography/Text";
...
export const TakeawayScene: React.FC<SceneComponentProps> = ({
  background,
  content,
  visual,
  visualPosition,
      ...
      >
        ...
        {content.body ? (
          <EnterOnCue preset={motion?.entrance ?? "fade"} delay={staggerDelay(3, motion?.stagger)}>
            <BodyLargeText tone="secondary">{content.body}</BodyLargeText>
          </EnterOnCue>
        ) : null}
      </AbsoluteFill>
