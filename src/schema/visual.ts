...
export const screenAspectSchema = z.enum([
  "16:9",
  "16:10",
  "4:3",
  "1:1",
...
export const visualConfigSchema: z.ZodType<VisualConfig> = z.discriminatedUnion(
  "type",
  [
    z.object({
    ...
    z.object({
      ...
      size: z
        .enum(["hero", "headline", "title", "bodyLarge", "body", "label"])
        .optional(),
    ...
    z.object({
      ...
      overlay: z
        .object({
          ...
          items: z
            .array(
              z.object({ text: z.string(), selected: z.boolean().optional() }),
            )
            .min(1)
            .max(5),
        })
